...
<table>
    ...
    <tbody>
        {#if foods}
            {#each foods as food}
            <tr>
                <td><input id="food-checkbox" type="checkbox" value={food.foodName} bind:group={selectedFoodNames} on:change={calculateOrderTotal} /></td>
                <td><label for="food-checkbox">{food.foodName}</label></td>
                <td>{food.price}</td>
